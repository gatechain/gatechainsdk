...
```bash
go test -v --bench github.com/gatechain/gatechain/framework/crypto/keys/mintkey
```
...
goos: linux
goarch: amd64
pkg: github.com/gatechain/gatechain/framework/crypto/keys/mintkey
...
PASS
ok  	github.com/gatechain/gatechain/framework/crypto/keys/mintkey	12.093s
```
