...
var (
	...
	fsCommissionUpdateMaxRate = flag.NewFlagSet("", flag.ContinueOnError)
...
func init() {
	...
	fsCommissionUpdateMaxRate.String(FlagCommissionMaxRate, "", "The new commission max rate percentage")
	fsCommissionUpdateMaxRate.String(FlagCommissionMaxChangeRate, "", "The new commission max change rate percentage")
