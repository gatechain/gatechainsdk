...
type Application interface {
	...
	// if return true, means the tx not legal
	ReCheckTx(header Header, hash string, tx []byte) (ResponseTx, bool)
...
func (ProxyBaseApplication) ReCheckTx(header Header, hash string, tx []byte) (ResponseTx, bool) {
	return ResponseTx{Response: ResponseStatus{Code: CodeTypeOK}}, true
}
