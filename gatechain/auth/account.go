...
func NewBaseAccount(address types.AccAddress, coins types.Coins,
...
// SetPubKey - Implements framework.Account.
...
// GetSequence - Implements framework.Account.
func (acc *BaseAccount) GetSequence() uint64 {
	return acc.Sequence
}

// SetSequence - Implements framework.Account.
...
func NewBaseVestingAccount(vaultAccount *VaultAccount, originalVesting types.Coins,
...
func (bva BaseVestingAccount) String() string {
	...
	if bva.PubKey != nil {
		pubkey = types.MustBech32ifyAccPub(bva.PubKey)
	}
...
func NewContinuousVestingAccount(
	vaultAccount *VaultAccount, StartTime, EndTime int64,
) *ContinuousVestingAccount {

	baseVestingAcc := &BaseVestingAccount{
		VaultAccount:    vaultAccount,
		OriginalVesting: vaultAccount.Coins,
		EndTime:         EndTime,
	}
...
func (cva ContinuousVestingAccount) String() string {
	...
	if cva.PubKey != nil {
		pubkey = types.MustBech32ifyAccPub(cva.PubKey)
	}
...
func NewDelayedVestingAccount(vaultAccount *VaultAccount, EndTime int64) *DelayedVestingAccount {
	baseVestingAcc := &BaseVestingAccount{
		VaultAccount:    vaultAccount,
		OriginalVesting: vaultAccount.Coins,
		EndTime:         EndTime,
